...
<span style="font-size:1.25em;">A central server managing communication between bots in a botnet can be vulnerable to attacks by different agencies in a number of ways. For this reason the key exchange would normally be implemented along side some form of authentication. This can include the following:</span>
